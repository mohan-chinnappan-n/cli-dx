...
- [View a  FlexiPage](#viewFP)
    - [JSON version of FlexiPage](#jsonfp)
...
### JSON Version
```
$ sfdx mohanc:xml:parse -i unpackaged/flexipages/Opportunity_Record_Page.flexipage 
=== Writing the JSON into file : unpackaged/flexipages/Opportunity_Record_Page.flexipage.json ===

```
```
$ cat unpackaged/flexipages/Opportunity_Record_Page.flexipage.json   
```
```json
